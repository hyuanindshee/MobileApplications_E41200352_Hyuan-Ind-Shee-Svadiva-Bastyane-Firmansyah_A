...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String[] MAJOR = new String[]{
            "Aceh","Sumatra Utara","Sumatra Barat","Riau","Kepulauan Riau","Jambi","Bengkulu","Sumatra Selatan","Kepulauan Bangka Belitung","Lampung",
            ...
            "Sulawesi Barat","Sulawesi Selatan","Sulawesi Tenggara","Maluku Utara","Maluku","Papua Barat","Papua"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(parent.getContext(), "Anda klik provinsi" + provinsi, Toast.LENGTH_SHORT).show();
            }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(getApplicationContext(), "Anda klik provinsi:" + parent.getItemAtPosition(position), Toast.LENGTH_SHORT).show();
            }
        });
